...
{
    public class BLedgerRevenueExpense
    {
        LedgerRevenueExpenseDAL objLedgerRevenueExpenseDAL = new LedgerRevenueExpenseDAL();


        private List<EAccountStatement> GetAllJournalByAccount(DateTime fromDate, DateTime toDate, string accTitle, long accId,DateTime fiscalStartDate)
        {
            List<EAccountStatement> listGetAS = objLedgerRevenueExpenseDAL.GetAllJournalByAccount(fromDate, toDate, accTitle, accId,fiscalStartDate);
            ...
            foreach (string id in listofJVId)
            {
                ...
                {
                    bool isAccTypeAbsent = objLedgerRevenueExpenseDAL.CheckAccTypeAbsent(accId, id);//Check same type of account
                    foreach (var objEAS in objLedgerRevenueExpenseDAL.GetJournalInfo(listGetAS, id))
                    {
                        ...
                        if (isAccTypeAbsent == true)
                        {
                            ...
                            if (accId != objECreateAS.AccountId)
                            {
                                ...
                                {
                                    objECreateAS.ChequeNo = objLedgerRevenueExpenseDAL.GetOpponetAccInfo(objECreateAS.ID, id, objECreateAS.IsDebit).ChequeNo;
                                }
                        ...
                        else
                        {
                            if (accId == objECreateAS.AccountId)
                            {
                                ...
                                objECreateAS.AccountCode = objLedgerRevenueExpenseDAL.GetOpponetAccInfo(objECreateAS.ID, id, objECreateAS.IsDebit).AccountCode;
                                listFinalAS.Add(objECreateAS);
                                //break;
                            }
                        }
        ...
        public List<EAccountStatement> GetAccStatement(DateTime fromDate, DateTime toDate, string accTitle,long accId,DateTime fiscalStartDate)
        {
            List<EAccountStatement> listFinal = GetAllJournalByAccount(fromDate, toDate, accTitle, accId, fiscalStartDate);
